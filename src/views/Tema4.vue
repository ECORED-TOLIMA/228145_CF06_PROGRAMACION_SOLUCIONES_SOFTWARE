...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
        ...
        .tarjeta--container.row
          .col-xl.col-lg-6.tarjeta.tarjeta-bg2.p-5
            .row.justify-content-center.mb-3
              .col-lg-5.col-4
                figure
                  img(src='@/assets/curso/temas/tema4/img1.svg', alt='')(style="width: 100%")
            p.text-center #[b Arreglos (arrays)]
            p.mb-3 Permiten almacenar múltiples valores en una sola variable.
            p.mb-3 #[b Ejemplo:]
            .tarjeta--fondo9.p-3
          ...
          .col-xl.col-lg-6.tarjeta.tarjeta-bg4.p-5
            .row.justify-content-center.mb-3
              .col-lg-5.col-4
                figure
                  img(src='@/assets/curso/temas/tema4/img2.svg', alt='')(style="width: 100%")
            p.text-center #[b Objetos (objects)]
            p.mb-3 Permiten almacenar información en pares clave–valor.
            p.mb-3 #[b Ejemplo:]
            .tarjeta--fondo9.p-3
          ...
          .col-xl.col-lg-6.tarjeta.tarjeta-bg3.p-5
            .row.justify-content-center.mb-3
              .col-lg-5.col-4
                figure
                  img(src='@/assets/curso/temas/tema4/img3.svg', alt='')(style="width: 100%")
            p.text-center #[b Pilas (stacks)]
            p.mb-3 Siguen el principio LIFO (último en entrar, primero en salir).
            p.mb-3 #[b Ejemplo:]
            .tarjeta--fondo9.p-3
          ...
          .col-xl.col-lg-6.tarjeta.tarjeta-bg7.p-5
            .row.justify-content-center.mb-3
              .col-lg-5.col-4
                figure
                  img(src='@/assets/curso/temas/tema4/img4.svg', alt='')(style="width: 100%")
            p.text-center #[b Colas (queues)]
            p.mb-3 Siguen el principio FIFO (primero en entrar, primero en salir).
            p.mb-3 #[b Ejemplo:]
            .tarjeta--fondo9.p-3
    ...
    .row.justify-content-center.mb-4
      .col-lg-10
        p De igual manera, se presentan algunos algoritmos básicos ampliamente utilizados en programación, orientados a la búsqueda, organización y recorrido de datos, con ejemplos que facilitan la comprensión de su lógica y aplicación práctica:
    ...
    .row.justify-content-center
      .col-lg-10
        p Las estructuras de datos y algoritmos permiten organizar mejor la información, optimizar el rendimiento de los programas y resolver problemas de manera eficiente, comprender las estructuras de datos y los algoritmos es esencial para desarrollar #[i software] eficiente y de calidad en JavaScript.
    ...
    .row.justify-content-center.mb-4
      .col-lg-5.col-10.mb-4.mb-lg-0.d-none.d-lg-block
        figure
    ...
    .tarjeta--BG02.tarjeta--BG02-matrices.px-md-5.p-lg-0.p-4.slyderF-wrapper
      .slyderF-container
        .row.justify-content-center.align-items-center.my-lg-5.my-4
          .col-lg-4.col-md-8.col-sm-6.mb-md-4.mb-sm-4.desktop
            figure(data-aos="zoom-in")
              img(src="@/assets/curso/temas/tema4/img7.png", alt='alt' style='margin-bottom: -25px;')
          .col-lg-8
            SlyderF.custom.color-acento-botones(columnas="col-12")
              .tarjeta.bgslyder.p-4
                p.mb-3 #[b • Acceso a elementos]
                p.mb-3 Para acceder a un elemento se utilizan dos índices: fila y columna.
                p.mb-3 Ejemplo:
                .tarjeta--fondo4.p-2
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-lg-6
        .tarjeta-avatar-b
          ...
          .tarjeta.tarjeta-bg5
            .p-4
              p #[b Algoritmos eficientes (O(n log n))]
    ...
    p.mb-4 Basado en lo anterior, se resume y relaciona la comparación de algoritmos:
    .row.mb-5
      .col-lg.col-md-6.tarjeta-bg2.p-4(data-aos="fade-right")
    ...
    .row.justify-content-center
      .col-lg-4.col-8.mb-4.mb-lg-0.d-none.d-lg-block
        figure
    ...
    datosSlyder: [
      {
        ...
        texto:
          'Busca el valor mínimo del arreglo y lo coloca en la posición correcta. <br><br><b>Complejidad:</b> O(n²). <br><b>Uso:</b> útil para aprendizaje y estructuras pequeñas.',
        imagen: require('@/assets/curso/temas/tema4/img15.png'),
      },
      {
        titulo: 'Insertion Sort',
        texto:
          'Inserta cada elemento en su posición adecuada dentro de una lista parcialmente ordenada. <br><br><b>Complejidad:</b> O(n²). <br><b>Ventaja:</b>  eficiente en listas pequeñas o casi ordenadas.',
        imagen: require('@/assets/curso/temas/tema4/img16.png'),
      },
      {
        titulo: 'QuickSort',
        texto:
          'Algoritmo basado en la técnica “divide y vencerá”. Utiliza un pivote para dividir el arreglo. <br><br><b>Complejidad:</b> O(n log n).  <br>Es uno de los algoritmos más utilizados en sistemas reales.',
        imagen: require('@/assets/curso/temas/tema4/img17.png'),
      },
      {
        titulo: 'MergeSort',
        texto:
          'Divide el arreglo en partes iguales, las ordena y luego las combina. <br><br><b>Complejidad:</b> O(n log n) <br><b>Ventaja:</b> rendimiento estable incluso con grandes volúmenes de datos.',
        imagen: require('@/assets/curso/temas/tema4/img18.png'),
      },
    ],
  }),
  mounted() {
