...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
        ...
        .row.justify-content-center.align-items-center.my-lg-5.my-4
          .col-lg-4.col-md-8.col-sm-6.mb-md-4.mb-sm-4.desktop
            figure(data-aos="zoom-in")
              img(src="@/assets/curso/temas/tema5/img2.png", alt='alt' style='margin-bottom: -25px;')
          .col-lg-8
            SlyderF.custom.color-acento-botones(columnas="col-12")
              .tarjeta.bgslyder.p-4
                p.mb-3 #[b • Consola (console.log)]
              ...
              .tarjeta.bgslyder.p-4
                p.mb-3 #[b • Herramientas de desarrollador (DevTools)]
    ...
    p En el desarrollo de #[i software], uno de los errores más comunes que enfrentan los programadores son las fallas de sintaxis, también conocidas como SyntaxError. Estas ocurren cuando el código escrito no cumple con las reglas gramaticales del lenguaje de programación, impidiendo que el intérprete o el motor de JavaScript pueda comprender y ejecutar correctamente el programa.
    ...
    .row.justify-content-center
      .col-lg-10
        .box___style_2(data-aos="zoom-in").mb-4
          .row.align-items-center
            .col-xl-auto.d-none.d-lg-block
              figure
                img(src='@/assets/curso/temas/tema5/img7.png', alt='').m-auto
            .col-xl.fit___box_container2
        ...
        p.mb-4.text-center Para la sintaxis de fallas, se ejemplifica con los siguientes códigos de programación:          
      ...
      .col-lg-10.d-none.d-lg-block
        ImagenInfografica.color-acento-botones
          ...
          .tarjeta.tarjeta-bg4.p-3(x="7%" y="43%" numero="+")
            p Se ejecuta cuando ocurre un error en el bloque try, capturando el objeto de error.
        ...
        .tarjeta-foto-hover
          ...
          .tarjeta-foto-hover__content
            .tarjeta-foto-hover__icon
              i.fas.fa-chevron-up
            h5.mb-0 Gestión de errores de API y red
            .tarjeta-foto-hover__body.mt-5
              p.mb-0 Si una solicitud a una API falla, el sistema puede reintentar la operación o mostrar un mensaje de error al usuario.
      ...
      .col-md-6.col-lg-4.mb-4
        .tarjeta-foto-hover
          ...
          .tarjeta-foto-hover__content
            .tarjeta-foto-hover__icon
              i.fas.fa-chevron-up
            h5.mb-0 Validación de la entrada del usuario
            .tarjeta-foto-hover__body.mt-5
              p.mb-0 Si el usuario introduce datos inválidos, el sistema puede solicitar correcciones sin interrumpir la ejecución de la aplicación.
      ...
      .col-md-6.col-lg-4.mb-4
        .tarjeta-foto-hover
          ...
          .tarjeta-foto-hover__content
            .tarjeta-foto-hover__icon
              i.fas.fa-chevron-up
            h5.mb-2 Prevención de fallos en la aplicación
            .tarjeta-foto-hover__body.mt-5
              p.mb-0 Al manejar valores inesperados o datos faltantes, se garantiza que el sistema continúe funcionando correctamente.
    p.mb-4.text-center Se relacionan algunos ejemplos de manejo de errores en JavaScript, partiendo de lo siguiente: 
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-10
        .cajon.cajon.C02.color-secundario.p-4
          p.mb-4 ¿Cómo manejar errores en código asíncrono? Cuando se trabaja con funciones asíncronas y promesas, los errores pueden gestionarse usando .catch().             
    .row.justify-content-center.align-items-center.mb-4
      .col-lg-10
        .tarjeta.color-primario.p-0.mt-3.overflow-hidden.mb-4
          .px-3.py-2(style="background-color: #3A1D71; display: flex; align-items: center;")
        ...
        .tarjeta--container.row
          .col-xl.col-lg-6.tarjeta.tarjeta-bg2.p-5
            .row.justify-content-center.mb-3
              .col-lg-5.col-4
                figure
                  img(src='@/assets/curso/temas/tema5/img12.svg', alt='')(style="width: 100%")
            h5.text-center ReferenceError
            p.mb-2 Se intenta usar una variable que no ha sido definida.
            p.mb-0 #[b Ejemplo]:
            .tarjeta--fondo9.p-3
              p.text-white.mb-1 console.log(nonExistentVar); // ReferenceError
          .col-xl.col-lg-6.tarjeta.tarjeta-bg4.p-5
            .row.justify-content-center.mb-3
              .col-lg-5.col-4
                figure
                  img(src='@/assets/curso/temas/tema5/img13.svg', alt='')(style="width: 100%")
            h5.text-center TypeError
            p.mb-2 Se intenta ejecutar una operación sobre un tipo de dato incorrecto.
            p.mb-0 #[b Ejemplo]:
            .tarjeta--fondo9.p-3
              p.text-white.mb-1 let num = 42;
              p.text-white.mb-1  num.toUpperCase(); // TypeError
          .col-xl.col-lg-6.tarjeta.tarjeta-bg1.p-5
            .row.justify-content-center.mb-3
              .col-lg-5.col-4
                figure
                  img(src='@/assets/curso/temas/tema5/img14.svg', alt='')(style="width: 100%")
          ...
          .col-xl.col-lg-6.tarjeta.tarjeta-bg7.p-5
            .row.justify-content-center.mb-3
              .col-lg-5.col-4
                figure
                  img(src='@/assets/curso/temas/tema5/img15.svg', alt='')(style="width: 100%")
            h5.text-center RangeError
            p.mb-2 Ocurre cuando se excede el rango permitido de valores.
            p.mb-0 #[b Ejemplo]:
            .tarjeta--fondo9.p-3
              p.text-white.mb-1 function recurse() {
              p.text-white.mb-1 return recurse();
              p.text-white.mb-1 }
              p.text-white.mb-1 recurse(); // RangeError: Se excedió el tamaño máximo de la pila de llamadas
    separador
    #t_5_3.titulo-segundo.color-acento-contenido(data-aos="fade-left")
      h2 5.3 Fallas de lógica
    ...
    AcordionA(tipo="a" clase-tarjeta="tarjeta tarjeta--azul")
        ...
        .row.justify-content-center
          .col-lg-10
            .tarjeta--fondo9.p-4
              ...
              p.text-white.mb-1  Corrección:
              p.text-white.mb-1  let a = 5;
              p.text-white.mb-1  if (a === 10) {
              p.text-white.mb-1    console.log('Verdadero');
              p.text-white.mb-1  } else {
              p.text-white.mb-1    console.log('Falso');
              p.text-white.mb-1  }  
      ...
      .row(titulo="b) Condiciones mal planteadas")
        ...
        .row.justify-content-center
          .col-lg-10
            .tarjeta--fondo9.p-4
              p.text-white.mb-1 let edad = 18;
              p.text-white.mb-1  if (edad > 18) {
              p.text-white.mb-1    console.log('Mayor de edad');
              p.text-white.mb-1  }
              p.text-white.mb-1  // Error: debería ser >= 18
              p.text-white.mb-1  Aquí, una persona de 18 años no sería reconocida como mayor de edad, aunque en muchos contextos sí lo es. El error no está en la sintaxis, sino en la lógica de la condición.
              p.text-white.mb-1  Corrección:
              p.text-white.mb-1  let edad = 18;
              p.text-white.mb-1  if (edad >= 18) {
              p.text-white.mb-1    console.log('Mayor de edad');
              p.text-white.mb-1  } else {
              p.text-white.mb-1    console.log('Menor de edad');
              p.text-white.mb-1  }  
          .col-lg-2.d-none.d-lg-block
            figure
      ...
      .row(titulo="c) Bucles infinitos")
        ...
        .row.justify-content-center
          .col-lg-10
            .tarjeta--fondo9.p-4
              p.text-white.mb-1 let i = 0;
              p.text-white.mb-1  while (i < 5) {
              p.text-white.mb-1    console.log(i);
              p.text-white.mb-1  }
              p.text-white.mb-1  // Error: falta incrementar i
              p.text-white.mb-1  En este caso, la variable i nunca cambia, por lo que la condición i < 5 siempre será verdadera. El ciclo se ejecutará indefinidamente.
      ...
      .row(titulo="d) Comparación de tipos incorrecta")
        ...
        .row.justify-content-center
          .col-lg-10
            .tarjeta--fondo9.p-4
              p.text-white.mb-1 console.log(5 == '5'); // true
              p.text-white.mb-1  console.log(5 === '5'); // false
              p.text-white.mb-1  Con ==, JavaScript convierte automáticamente la cadena '5' en número y luego realiza la comparación. Con ===, en cambio, también verifica el tipo de dato, lo cual lo hace más seguro.
      ...
      .row(titulo="e) Variables no inicializadas")
        ...
        .row.justify-content-center
          .col-lg-10
            .tarjeta--fondo9.p-4
              p.text-white.mb-1 let x;
              p.text-white.mb-1  console.log(x + 5); // NaN

              p.text-white.mb-1  Como x no tiene un valor numérico asignado, la operación no puede realizarse adecuadamente y el resultado es NaN (Not a Number). Este tipo de fallas suele afectar cálculos, formularios y procesos de validación.

              p.text-white.mb-1  Corrección:
              p.text-white.mb-1  let x = 0;
      ...
      .row(titulo="f) Índices fuera de rango")
        ...
        .row.justify-content-center
          .col-lg-10
            .tarjeta--fondo9.p-4
              p.text-white.mb-1 let arr = [1, 2, 3];
              p.text-white.mb-1  console.log(arr[5]); // undefined

              p.text-white.mb-1  Si después se intenta sumar, convertir o manipular ese valor, el programa puede producir resultados erróneos. Por esta razón, es importante validar siempre los límites del arreglo.

              p.text-white.mb-1  Corrección:
              p.text-white.mb-1  let arr = [1, 2, 3];
              p.text-white.mb-1  if (arr[2] !== undefined) {
              p.text-white.mb-1    console.log(arr[2]);
              p.text-white.mb-1 }
          .col-lg-2.d-none.d-lg-block
            figure
      ...
      .row(titulo="g) Mutación no deseada de datos")
        ...
        .row.justify-content-center
          .col-lg-10
            .tarjeta--fondo9.p-4
              p.text-white.mb-1 let lista = [1, 2, 3];
              p.text-white.mb-1  let copia = lista;
              p.text-white.mb-1  copia[0] = 99;
              p.text-white.mb-1  // lista también cambia
              p.text-white.mb-1  Aquí, copia no es un nuevo arreglo, sino una referencia al mismo arreglo original. Por eso, al cambiar copia[0], también cambia lista[0].
        ...
        .row.justify-content-center
          .col-lg-10
            .tarjeta--fondo9.p-4
              ...
              p.text-white.mb-1    let resultado = a + b;
              p.text-white.mb-1  }
              p.text-white.mb-1  console.log(sumar(2, 3)); // undefined
              p.text-white.mb-1  La función realiza el cálculo, pero no usa return. Por tanto, el resultado no sale de la función.

              p.text-white.mb-1  Corrección:
              p.text-white.mb-1  function sumar(a, b) {
              p.text-white.mb-1    let resultado = a + b;
              p.text-white.mb-1    return resultado;
              p.text-white.mb-1  }
      ...
      .row(titulo="i) Uso incorrecto de condiciones compuestas")
        ...
        .row.justify-content-center
          .col-lg-10
            .tarjeta--fondo9.p-4
              p.text-white.mb-1 let edad = 20;
              p.text-white.mb-1  let tieneDocumento = false;
              p.text-white.mb-1  if (edad >= 18 || tieneDocumento) {
              p.text-white.mb-1    console.log('Puede ingresar');
              p.text-white.mb-1  }

              p.text-white.mb-1  Si la regla real exige ser mayor de edad y además tener documento, esta condición está mal planteada, porque basta con cumplir una de las dos.

              p.text-white.mb-1  Corrección:
              p.text-white.mb-1  if (edad >= 18 && tieneDocumento) {
              p.text-white.mb-1    console.log('Puede ingresar');
              p.text-white.mb-1  } else {
              p.text-white.mb-1    console.log('No puede ingresar');
              p.text-white.mb-1  }
          .col-lg-2.d-none.d-lg-block
            figure
      ...
      .row(titulo="j) Confusión entre incremento previo y posterior")
        ...
        .row.justify-content-center
          .col-lg-10
            .tarjeta--fondo9.p-4
              p.text-white.mb-1 let x = 5;
              p.text-white.mb-1  let y = x++;
              p.text-white.mb-1  console.log(x); // 6
              p.text-white.mb-1  console.log(y); // 5

              p.text-white.mb-1  Aquí, y recibe primero el valor actual de x y luego x se incrementa. Si el desarrollador esperaba que y valiera 6, tendría una falla lógica.

              p.text-white.mb-1  Comparación:
              p.text-white.mb-1  let a = 5;
              p.text-white.mb-1  let b = ++a;
              p.text-white.mb-1  console.log(a); // 6
    ...
    #t_5_4.titulo-segundo.color-acento-contenido(data-aos="fade-left")
      h2 5.4 Manejo de errores y excepciones
    .BG01.px-5
      .row.justify-content-center.align-items-center.mb-4
